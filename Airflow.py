...
# ชื่อของ connection ใน Airflow ที่เซ็ตเอาไว้
...
with DAG(
    ...
    #create task สำหรับทำ dependencies
    t1 = PythonOperator(
    ...
    t4 = BashOperator(
        task_id="load_to_bq",
        bash_command="bq load --source_format=CSV --autodetect final_big.result_data gs://asia-east2-workshop5-03d65f08-bucket/data/output.csv"
    )
